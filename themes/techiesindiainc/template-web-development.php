...
wp();
/*
Template Name: Landing Web Development
*/
?>
<!DOCTYPE html>
<html lang="en">
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-66148433-6"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'UA-66148433-6');
  gtag('config', 'AW-954578551');
</script>
<!-- Hotjar Tracking Code for http://techiesindiainc.com/ -->
<script>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:303859,hjsv:5};
...
<body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a href="/landing/web-development-company" class="navbar-brand brand scrool"><img src="<?php echo bloginfo('template_directory');?>/webdev/images/techieslogo.png" alt="Techies India Inc" title="Techies India Inc" /></a>
                </div>
    ...
    <section id="home_wrapper" class="home-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="home-title wow fadeIn" data-wow-delay="0.5s">Promote your Business with Innovative Designs and Creative Solutions by Techies.</h1>
                    <p class="home-subtitle wow fadeIn" data-wow-delay="1s">
                        Innovation in designs enhances the look and Creativity in solutions inspires the customers to accept the new way out. With the inputs of Innovation, Imagination, Creativity and Empathy we create Value and deliver quality to our Customers. Our committed and passionate team always strikes a balance between imagination and expectation to provide customer centric solutions.
                    </p>
                    <a href="#contact" class="btn btn-lg btn-white-transparent scrool wow fadeIn" data-wow-delay="1.5s">Say Hi!</a>
                </div>
                <div class="col-md-6 wow slideInRight" data-wow-delay="2s">
                    <img src="<?php echo bloginfo('template_directory');?>/webdev/images/imac3.png" alt="Professional Web Development" class="width-100" />
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 margin-top-30 margin-bottom-30">
                    <img src="<?php echo bloginfo('template_directory');?>/webdev/images/img1.png" alt="Web Development Services" class="width-100" />
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="story-block story-left">
                        ...
                        <div class="story-image">
                            <img src="<?php echo bloginfo('template_directory');?>/webdev/images/icons/design.png" alt="">
                        </div>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="story-block story-right">
                        ...
                        <div class="story-image">
                            <img src="<?php echo bloginfo('template_directory');?>/webdev/images/icons/clean-coding.png" alt="">
                        </div>
                        <span class="story-arrow"></span>
                        <span class="h-line"></span>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="story-block story-left">
                        ...
                        <div class="story-image">
                            <img src="<?php echo bloginfo('template_directory');?>/webdev/images/icons/easily.png" alt="">
                        </div>
                        <span class="story-arrow"></span>
                        <span class="h-line"></span>
                    </div>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="story-block story-right">
                        ...
                        <div class="story-image">
                            <img src="<?php echo bloginfo('template_directory');?>/webdev/images/icons/seo.png" alt="">
                        </div>
                        <span class="story-arrow"></span>
                        <span class="h-line"></span>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <div class="story-block story-left">
                        ...
                        <div class="story-image">
                            <img src="<?php echo bloginfo('template_directory');?>/webdev/images/icons/code.png" alt="">
                        </div>
                        <span class="story-arrow"></span>
                        <span class="h-line"></span>
                    </div>
                ...
                <div class="col-md-6 col-sm-12">
                    <div class="story-block story-right">
                        ...
                        <div class="story-image">
                            <img src="<?php echo bloginfo('template_directory');?>/webdev/images/icons/support.png" alt="">
                        </div>
                        <span class="story-arrow"></span>
                        <span class="h-line"></span>
                    </div>
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item">
							...
							<div class="col-md-3 col-sm-3 team-item">
								...
								<div class="team-box">
									<h3>Gourav Verma</h3>
									<p class="team-info">Web Designer</p>
								</div>
							</div>
                        </div>
						<div class="item">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="partners-wrapper">
                        <div class="col-md-4 partners-item"><img src="<?php echo bloginfo('template_directory');?>/webdev/images/eurow.png" alt="Eurow"></div>
                        <div class="col-md-4 partners-item"><img src="<?php echo bloginfo('template_directory');?>/webdev/images/yellow.png" alt="Yellow"></div>
                        <div class="col-md-4 partners-item last"><img src="<?php echo bloginfo('template_directory');?>/webdev/images/reg.png" alt="Regents Park Pharmacy"></div>
                        <div class="col-md-4 partners-item no-border-bottom"><img src="<?php echo bloginfo('template_directory');?>/webdev/images/carluxlimo.png" alt="CarLuxLimo"></div>
                        <div class="col-md-4 partners-item no-border-bottom"><img src="<?php echo bloginfo('template_directory');?>/webdev/images/aqua.png" alt="Aqua"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                  ...
                  Phone: +61 406 756 797</div>
                    ...
                    <div class="copyright">
                        <p>&copy <?php echo date('Y');?> Techies India Inc. Premium web development company. <a href="/privacy-policy/" target="_blank" style="text-decoration:none;">Privacy Policy</a> </p>
                    </div>
